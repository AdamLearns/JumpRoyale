...
public class CommandHandler(string message, string senderId, string senderName, string hexColor, bool isPrivileged)
{
    ...
    public void SpawnFakePlayers()
    {
        ...
        // anyway. Ultimately, we would have some trigger preventing the serialization if dummies were spawned. It
        // sometimes throws an exception on first dummy with id 0, maybe my keyboard is double-tapping ツ
